          ...
          <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-32 gap-y-14 xl:max-w-none xl:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg tracking-tight text-blue-900">
                Nhận thông tin cập nhật về tất cả các khuyến mãi của chúng tôi và là người đầu tiên nhận được
                được khuyến mãi của sản phẩm
              </p>
            </div>
            <form>
              <h3 className="text-lg font-semibold tracking-tight text-blue-900">
                Đăng ký email <span aria-hidden="true">&darr;</span>
              </h3>
              <div className="mt-5 flex rounded-3xl bg-white py-2.5 pr-2.5 shadow-xl shadow-blue-900/5 focus-within:ring-2 focus-within:ring-blue-900">
                ...
                />
                <Button type="submit">
                  <span className="sr-only sm:not-sr-only">Đăng ký</span>
